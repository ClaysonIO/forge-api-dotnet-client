...
namespace Autodesk.Forge
{
    ...
    public interface IVersionsApi : IApiAccessor
    {
        ...
        /*CreatePdfResponse*/ CreatePdfResponse PostPdfExport(string projectId, string versionId, CreatePdf body);
        ...
        /*GetPdfResponse*/ CreatePdfGetResponse GetPdfExport(string projectId, string versionId, string exportId);
        #endregion Synchronous Operations
        #region Asynchronous Operations
        /// <summary>
        /// 
    ...
    public partial class VersionsApi : IVersionsApi
    {
        ...
        /// <param name="body">describe the ref to be created</param>
        /// <returns>CreatePdfResponse</returns>
        public /*CreatePdfResponse*/ CreatePdfResponse PostPdfExport(string projectId, string versionId, CreatePdf body)
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
                throw new ApiException(400, "Missing required parameter 'projectId' when calling VersionsApi->PostVersionRelationshipsRef");
        ...
        public /*CreatePdfGetResponse*/ CreatePdfGetResponse GetPdfExport(string projectId, string versionId, string exportId)
        {
            // verify the required parameter 'projectId' is set
            if (projectId == null)
